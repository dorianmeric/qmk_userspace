...
CAPS_KEY,          LWIN_T(KC_A),      BS_R,      BS_S,      BS_T,       KC_G,                       KC_M,               BS_N,      BS_E,      RALT_T(KC_I),       LWIN_T(KC_O),            KC_SCLN,           KC_ENT,          \
MT(MOD_LSFT,KC_Z),  KC_X,               KC_C,              KC_D,              KC_V,             KC_MINS,                    KC_K,              KC_H,               KC_COMM,             BS_DOT,       KC_QUOT,                 MT(MOD_RSFT,KC_UP),   \
...
KC_LSFT,             KC_Z,              BS_X,      KC_C,              KC_V,              KC_B,                      KC_N,              KC_M,              KC_COMM,           BS_DOT,    KC_SLSH,                MT(MOD_RSFT, KC_UP),                                \
KC_LCTL,             LT(U_MEDIA,KC_LWIN), LT(U_MOUSE,KC_TAB),          LT(U_NAV,KC_SPC),  xxxx,   LT(U_NUM,KC_BSPC),                LT(U_SYM,KC_ENT),     LT(U_FUN,KC_LEFT),     LT(U_MEDIA, KC_DOWN),                MT(MOD_RCTL, KC_RIGHT)
...
CAPS_KEY,          LWIN_T(KC_A),      BS_R,      BS_S,      BS_T,      KC_G,                        KC_M,               BS_N,      BS_E,      RALT_T(KC_I),       LWIN_T(KC_O),            KC_SCLN,           KC_ENT,          \
KC_LSFT,           KC_Z,               BS_X,      KC_C,              KC_D,              KC_V,                       KC_K,              KC_H,            KC_COMM,             BS_DOT,       KC_SLSH,                 MT(MOD_RSFT,KC_UP),   \
KC_LCTL,             LT(U_MEDIA,KC_LWIN), LT(U_MOUSE,KC_TAB),          LT(U_NAV,KC_SPC),  xxxx,   LT(U_NUM,KC_BSPC),                LT(U_SYM,KC_ENT),     LT(U_FUN,KC_LEFT),     LT(U_MEDIA, KC_DOWN),                MT(MOD_RCTL, KC_RIGHT)
