...
#include "layers.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_COLEMAKDHFATZ)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHFATZ
    #elif defined (MIRYOKU_ALPHAS_COLEMAKDHK)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
     ...
     #elif defined (MIRYOKU_EXTRA_COLEMAKDHFATZ)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHFATZ
    #elif defined (MIRYOKU_EXTRA_COLEMAKDHK)
